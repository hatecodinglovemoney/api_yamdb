# Generated by Django 3.2 on 2023-03-21 16:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('categoryorgenremodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='categories', serialize=False, to='reviews.categoryorgenremodel')),
            ],
            options={
            ...
            bases=('reviews.categoryorgenremodel',),
        ),
        migrations.CreateModel(
            name='Genre',
            fields=[
                ('categoryorgenremodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='genres', serialize=False, to='reviews.categoryorgenremodel')),
            ],
            options={
                'verbose_name': 'Жанр',
